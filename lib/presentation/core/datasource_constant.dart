...
const Color kBackgroundColorLight = const Color(0xFF3B3B89);
const Color kSecondRedColorLight = const Color(0xFFCE0F21);
const Color kSecondOrangeColorLight = const Color(0xFF888461);
const Color kThirdColorLight = const Color(0xFFC99A58);
